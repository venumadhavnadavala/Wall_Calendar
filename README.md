...
[cite_start]A polished, high-fidelity wall-calendar web app built with React, Tailwind CSS, and Framer Motion[cite: 3]. [cite_start]This project was developed as a **Frontend Engineering Challenge**, translating a static wall-calendar design into a functional, responsive digital component[cite: 3, 4].

## ✨ Features

| Feature | Details |
|---|---|
| **Wall Calendar Aesthetic** | [cite_start]Dedicated space for a hero image as a visual anchor, paired with an authentic spiral-binding design and paper-texture UI[cite: 6, 7, 26, 27]. |
| **Day Range Selector** | Select a start and end date across the grid. [cite_start]Includes clear visual states (band highlighting and rounded caps) for start, end, and in-range dates[cite: 28, 29]. |
...
| **Mood Tracker** | [cite_start]Extra feature allowing users to log daily energy/mood, visualized via color-coded badges and a range summary chart[cite: 37]. |
...
* [cite_start]**Editorial Typography**: Uses **Playfair Display** for headings and **DM Mono** for metadata to achieve a high-end luxury feel[cite: 6, 7].
* [cite_start]**Cohesive Accents**: Theme colors are extracted per theme and cascaded down via props for a cohesive magazine aesthetic[cite: 37].
